...
- **`SnapshotPolicy::Never`.** Same reason as the standalone example: the host SM here is in-memory only. Re-enable snapshots once you have persisted snapshot install/load on the host SM.
