...
## [0.3.0](https://github.com/prisma-risk/tsoracle/compare/tsoracle-server-v0.2.1...tsoracle-server-v0.3.0) - 2026-05-24
...
- *(server)* [**breaking**] surface reflection descriptor decode failure as a recoverable error ([#9](https://github.com/prisma-risk/tsoracle/pull/9)) ([#283](https://github.com/prisma-risk/tsoracle/pull/283))
