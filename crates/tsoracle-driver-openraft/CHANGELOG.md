...
## [2.2.0](https://github.com/prisma-risk/tsoracle/compare/tsoracle-driver-openraft-v2.1.0...tsoracle-driver-openraft-v2.2.0) - 2026-05-31
...
- *(e2e)* retire synthetic e2e-max-readable-next; soak real dense v4→v5 activation ([#588](https://github.com/prisma-risk/tsoracle/pull/588))
- *(consensus)* [**breaking**] typed AdvanceOutOfRange variant end-to-end ([#569](https://github.com/prisma-risk/tsoracle/pull/569))

## [1.0.1](https://github.com/prisma-risk/tsoracle/compare/tsoracle-driver-openraft-v1.0.0...tsoracle-driver-openraft-v1.0.1) - 2026-05-27

### Other

- updated the following local packages: tsoracle-core, tsoracle-consensus

## [0.3.3](https://github.com/prisma-risk/tsoracle/compare/tsoracle-driver-openraft-v0.3.2...tsoracle-driver-openraft-v0.3.3) - 2026-05-26
...
- *(driver-openraft)* enforce lower-bound on format activation target ([#479](https://github.com/prisma-risk/tsoracle/pull/479))
